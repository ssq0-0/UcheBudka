...
from HW.views import login_, StudentAPIView, HWAPIModelViewSet, HWParamsFroStudentAPIView, ProfileAPIView, TeacherMarkAPIViewSet, UserRegistrationAPIView, DiaryAPIView, main_, HWPage_, Diary_, lk_


router = routers.SimpleRouter()
router.register(r'HW', HWAPIModelViewSet, basename='HWAPIModelViewSet')
print(router.urls)
